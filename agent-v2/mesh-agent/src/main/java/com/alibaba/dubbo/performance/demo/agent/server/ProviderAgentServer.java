...
public class ProviderAgentServer implements AgentServer {
    ...
    public static EventLoopGroup worker = new EpollEventLoopGroup();

    public static LongObjectHashMap<Channel> channels = new LongObjectHashMap<>();
                ...
                .childHandler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ch.pipeline().addLast(
                                ...
                                new ProtobufEncoder(),
                                new ProviderAgentServerHandler());
                    }
                });
    }
